...
#             corners_hat = np.array([[u_hat[0]],
#                                     [v_hat[0]],
#                                     [1]], dtype = float)
#             reprojected_corners_img.append((corners_hat[0,0],corners_hat[1,0]))
...
def main():
    ...
    error_all_images, reprojected_points = projection_error(K_new, K_distortion_new, Rt_all, images_corners, world_corners)
